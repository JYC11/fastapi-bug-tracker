...
def upgrade() -> None:
    ...
    op.create_index(op.f("ix_bug_tracker_tags_id"), "bug_tracker_tags", ["id"], unique=False)
    op.create_table(
        "bug_tracker_users",
        sa.Column("id", postgresql.UUID(as_uuid=True), nullable=False),
        sa.Column(
    ...
    op.create_index(op.f("ix_bug_tracker_users_id"), "bug_tracker_users", ["id"], unique=False)
    op.create_table(
        "bug_tracker_bugs",
        sa.Column("id", postgresql.UUID(as_uuid=True), nullable=False),
        sa.Column(
        ...
        sa.ForeignKeyConstraint(["assigned_user_id"], ["bug_tracker_users.id"], ondelete="cascade"),
        sa.ForeignKeyConstraint(["author_id"], ["bug_tracker_users.id"], ondelete="cascade"),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_index(
    ...
    op.create_index(op.f("ix_bug_tracker_bugs_id"), "bug_tracker_bugs", ["id"], unique=False)
    op.create_table(
        "bug_tracker_bug_tag",
        sa.Column("id", postgresql.UUID(as_uuid=True), nullable=False),
        sa.Column(
        ...
        sa.ForeignKeyConstraint(["bug_id"], ["bug_tracker_bugs.id"], ondelete="cascade"),
        sa.ForeignKeyConstraint(["tag_id"], ["bug_tracker_tags.id"], ondelete="cascade"),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_index(
    ...
    op.create_index(op.f("ix_bug_tracker_bug_tag_id"), "bug_tracker_bug_tag", ["id"], unique=False)
    op.create_index(
    ...
    op.create_index(op.f("ix_bug_tracker_comments_id"), "bug_tracker_comments", ["id"], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f("ix_bug_tracker_comments_bug_id"), table_name="bug_tracker_comments")
    op.drop_index(op.f("ix_bug_tracker_comments_author_id"), table_name="bug_tracker_comments")
    op.drop_table("bug_tracker_comments")
    op.drop_index(op.f("ix_bug_tracker_bug_tag_tag_id"), table_name="bug_tracker_bug_tag")
    op.drop_index(op.f("ix_bug_tracker_bug_tag_id"), table_name="bug_tracker_bug_tag")
    op.drop_index(op.f("ix_bug_tracker_bug_tag_bug_id"), table_name="bug_tracker_bug_tag")
    ...
    op.drop_index(op.f("ix_bug_tracker_bugs_assigned_user_id"), table_name="bug_tracker_bugs")
    ...
    op.drop_index(op.f("ix_bug_tracker_event_store_id"), table_name="bug_tracker_event_store")
    op.drop_index(
        op.f("ix_bug_tracker_event_store_aggregate_id"),
